...
export default function Tableitems({ columns, data }) {
        ...
        <div className="-my-2 overflow-x-auto -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              <table {...getTableProps()} className="min-w-full divide-y divide-gray-200 text-custom-green">
                  ...
                  {headerGroups.map(headerGroup => (
                    <tr {...headerGroup.getHeaderGroupProps()}>
                      {headerGroup.headers.map(column => (
                        ...
                        <th
                          scope="col"
                          className="px-6 py-3 text-left text-xs font-medium text-custom-green bg-gray-100 uppercase tracking-wider"
      ...
      <div className="py-3 flex items-center justify-between">
        ...
        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
          <div className="flex  gap-x-5">
            <span className="text-lg text-gray-700 mt-2 ml-2 font-md">
